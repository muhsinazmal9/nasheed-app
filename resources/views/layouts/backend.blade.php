...
<head>
    ...
    <script async="" src="../gtag/js?id=G-9HQDQJJYW7"></script>
    <script>
        ...
        <aside id="side-overlay">
            <div class="content-header border-bottom">
                <a class="img-link me-1" href="javascript:void(0)">
                    <img class="img-avatar img-avatar32" src="{{ asset('assets') }}/media/avatars/avatar10.jpg"
                        alt="">
                </a>
                <div class="ms-2">
                                    ...
                                    <ul class="nav-items mb-0">
                                        ...
                                        <li>
                                            <a class="d-flex py-2" href="javascript:void(0)">
                                                <div class="me-3 ms-2 overlay-container overlay-bottom">
                                                    <img class="img-avatar img-avatar48"
                                                        src="{{ asset('assets') }}/media/avatars/avatar9.jpg"
                                                        alt="">
                                                    <span
                                                        class="overlay-item item item-tiny item-circle border border-2 border-white bg-success"></span>
                                                </div>
                                        ...
                                        <li>
                                            <a class="d-flex py-2" href="javascript:void(0)">
                                                <div class="me-3 ms-2 overlay-container overlay-bottom">
                                                    <img class="img-avatar img-avatar48"
                                                        src="{{ asset('assets') }}/media/avatars/avatar5.jpg"
                                                        alt="">
                                                    <span
                                                        class="overlay-item item item-tiny item-circle border border-2 border-white bg-success"></span>
                                                </div>
                                        ...
                                        <li>
                                            <a class="d-flex py-2" href="javascript:void(0)">
                                                <div class="me-3 ms-2 overlay-container overlay-bottom">
                                                    <img class="img-avatar img-avatar48"
                                                        src="{{ asset('assets') }}/media/avatars/avatar12.jpg"
                                                        alt="">
                                                    <span
                                                        class="overlay-item item item-tiny item-circle border border-2 border-white bg-warning"></span>
                                                </div>
                                    ...
                                    <form action="be_pages_dashboard.html" method="POST" onsubmit="return false;">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="space-y-2">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" value=""
                                                        id="so-settings-check3" name="so-settings-check3"
                                                        checked="">
                                                ...
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" value=""
                                                        id="so-settings-check4" name="so-settings-check4"
                                                        checked="">
                ...
                <div class="content-side">
                    <ul class="nav-main">
                        <li class="nav-main-item">
                            <a class="nav-main-link {{$title == 'dashboard'?'active':''}}" href="{{route('dashboard')}}">
                        ...
                        {{-- Artists --}}
                        <li class="nav-main-item">
                            <a class="nav-main-link {{$title == 'artists'?'active':''}}" href="{{route('artists.index')}}">
                                <i class="nav-main-link-icon si si-speedometer"></i>
