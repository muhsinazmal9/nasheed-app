    ...
    (function () {
      ...
      function te(e) {
        ...
        if (f) {
          ...
          L === C(i) &&
            ...
            (l === s || ((l === r || l === o) && c === d)) &&
              ((A = n),
              (y -= (g && L === S && S.visualViewport ? S.visualViewport.height : L[O]) - a.height),
              (y *= p ? 1 : -1)),
            (l !== r && ((l !== s && l !== n) || c !== d)) ||
              ((k = o),
              (b -= (g && L === S && S.visualViewport ? S.visualViewport.width : L[j]) - a.width),
              (b *= p ? 1 : -1));
        }
        var T,
        ...
        return (
          ...
          p
            ...
            : Object.assign(
                {},
                D,
                (((t = {})[A] = x ? y + "px" : ""), (t[k] = E ? b + "px" : ""), (t.transform = ""), t)
              )
        );
      }
      var ie = {
          ...
          : fe(
              (function (e) {
                var t,
                  ...
                  l = -s.scrollTop;
                return (
                  "rtl" === H(n || i).direction && (a += N(i.clientWidth, n ? n.clientWidth : 0) - o),
        ...
        Ee = {
          ...
          fn: function (e) {
            var t = e.state,
              ...
              u = d.y;
            null != t.modifiersData.popperOffsets &&
              ((t.modifiersData.popperOffsets.x += h), (t.modifiersData.popperOffsets.y += u)),
              (t.modifiersData[n] = c);
          },
        },
        xe = {
      ...
      function Ae(e, t, i) {
        ...
        return (
          (o || (!o && !i)) &&
            (("body" !== L(t) || he(a)) &&
              (c = (s = t) !== C(s) && j(s) ? { scrollLeft: (n = s).scrollLeft, scrollTop: n.scrollTop } : ce(s)),
      ...
      const Pe = new Map(),
        ...
        qe = (e) =>
          We(e) ? (e.jquery ? e[0] : e) : "string" == typeof e && e.length > 0 ? document.querySelector(Fe(e)) : null,
        $e = (e) => {
        ...
        Ze = (e, t, i, s) => {
          ...
          return -1 === o
            ? !i && s
              ? e[n - 1]
              : e[0]
            : ((o += i ? 1 : -1), s && (o = (o + n) % n), e[Math.max(0, Math.min(o, n - 1))]);
        },
        Ge = /[^.]*(?=\..*)\.|.*/,
        Je = /\..*/,
        et = /::\d+$/,
            ...
            ? (function (e, t, i) {
                return function s(n) {
                  ...
                  for (let { target: r } = n; r && r !== this; r = r.parentNode)
                    for (const a of o)
                      if (a === r)
                        return ft(n, { delegateTarget: r }), s.oneOff && pt.off(e, n.type, t, i), i.apply(r, [n]);
                };
              })(e, i, r)
            : (function (e, t) {
                return function i(s) {
        ...
        _addEventListeners() {
          this._config.keyboard && pt.on(this._element, Vt, (e) => this._keydown(e)),
            "hover" === this._config.pause &&
              (pt.on(this._element, Yt, () => this.pause()), pt.on(this._element, Xt, () => this._maybeEnableCycle())),
      ...
      class Qi extends vt {
        constructor(e, t) {
          super(e, t),
            ...
            (this._menu =
              wt.next(this._element, Fi)[0] || wt.prev(this._element, Fi)[0] || wt.findOne(Fi, this._parent)),
        ...
        static dataApiKeydownHandler(e) {
          ...
          const n = this.matches(Ni)
              ? this
              : wt.prev(this, Ni)[0] || wt.next(this, Ni)[0] || wt.findOne(Ni, e.delegateTarget.parentNode),
        ...
        show() {
          ...
          if (
            (this._element.ownerDocument.documentElement.contains(this.tip) ||
              (s.append(i), pt.trigger(this._element, this.constructor.eventName("inserted"))),
        ...
        Go = (function () {
          function e(t, i) {
            ...
            if (
              ...
              (this.onScroll = function () {
                ...
                s.scrollXTicking || (e.requestAnimationFrame(s.scrollX), (s.scrollXTicking = !0)),
                  ...
                  s.isScrolling || ((s.isScrolling = !0), Uo(s.el, s.classNames.scrolling)),
                  s.showScrollbar("x"),
                  s.showScrollbar("y"),
                  s.onStopScrolling();
              }),
              ...
              (this.drag = function (t) {
                ...
                if (s.draggedAxis && s.contentWrapperEl) {
                  var f = s.axis[s.draggedAxis].track,
                    m =
                      null !==
                        (n = null === (i = f.rect) || void 0 === i ? void 0 : i[s.axis[s.draggedAxis].sizeAttr]) &&
                      void 0 !== n
                        ? n
                        : 0,
                      ...
                      null !==
                        (r =
                          null === (o = s.contentWrapperEl) || void 0 === o
                            ? void 0
                            : o[s.axis[s.draggedAxis].scrollSizeAttr]) && void 0 !== r
                        ? r
                        : 0,
                    b = parseInt(
                      null !==
                        (l = null === (a = s.elStyles) || void 0 === a ? void 0 : a[s.axis[s.draggedAxis].sizeAttr]) &&
                        void 0 !== l
                        ? l
                        : "0px",
                      10
                  ...
                  var v =
                      ...
                      (null !==
                        (d = null === (c = f.rect) || void 0 === c ? void 0 : c[s.axis[s.draggedAxis].offsetAttr]) &&
                      void 0 !== d
                        ? d
                        : 0) -
                    ...
                    y =
                      ((v =
                        "x" === s.draggedAxis && s.isRtl
                          ? (null !==
                              (u =
                                null === (h = f.rect) || void 0 === h ? void 0 : h[s.axis[s.draggedAxis].sizeAttr]) &&
                            void 0 !== u
                              ? u
                              : 0) -
                            g.size -
                  ...
                  "x" === s.draggedAxis &&
                    s.isRtl &&
                    (y = (null === (p = e.getRtlHelpers()) || void 0 === p ? void 0 : p.isScrollingToNegative)
                      ? -y
                      : y),
            ...
            (this.onMouseMove = (function (e, t, i) {
              ...
              if ("function" != typeof e) throw new TypeError("Expected a function");
              return (
                ho(i) && ((s = "leading" in i ? !!i.leading : s), (n = "trailing" in i ? !!i.trailing : n)),
                No(e, t, { leading: s, maxWait: t, trailing: n })
              );
            })(this._onMouseMove, 64)),
              (this.onWindowResize = No(this._onWindowResize, 64, { leading: !0 })),
          ...
          return (
            (e.getRtlHelpers = function () {
              ...
              return (
                ...
                (e.rtlHelpers = { isScrollOriginAtZero: n.left !== o.left, isScrollingToNegative: o.left !== r.left }),
                e.rtlHelpers
              );
            }),
            ...
            (e.prototype.initDOM = function () {
              ...
              (this.wrapperEl = this.el.querySelector(Zo(this.classNames.wrapper))),
                (this.contentWrapperEl =
                  this.options.scrollableNode || this.el.querySelector(Zo(this.classNames.contentWrapper))),
                ...
                (this.axis.x.track.el = this.findChild(
                  this.el,
                  "".concat(Zo(this.classNames.track)).concat(Zo(this.classNames.horizontal))
                )),
                (this.axis.y.track.el = this.findChild(
                  this.el,
                  "".concat(Zo(this.classNames.track)).concat(Zo(this.classNames.vertical))
                )),
            ...
            (e.prototype.getScrollbarSize = function (e) {
              ...
              var s,
                ...
                o =
                  null !==
                    (i =
                      null === (t = this.axis[e].track.el) || void 0 === t ? void 0 : t[this.axis[e].offsetSizeAttr]) &&
                  void 0 !== i
                    ? i
                    : 0,
                r = o / n;
            ...
            (e.prototype.positionScrollbar = function (t) {
              ...
              if (this.axis[t].isOverflowing && this.contentWrapperEl && o.el && this.elStyles) {
                var r = this.contentWrapperEl[this.axis[t].scrollSizeAttr],
                  a =
                    (null === (i = this.axis[t].track.el) || void 0 === i ? void 0 : i[this.axis[t].offsetSizeAttr]) ||
                    0,
                ...
                (c =
                  ...
                  "x" === t &&
                    this.isRtl &&
                    (c = (null === (n = e.getRtlHelpers()) || void 0 === n ? void 0 : n.isScrollingToNegative)
                      ? c
                      : -c);
                var d = c / (r - l),
                  h = ~~((a - o.size) * d);
                (h = "x" === t && this.isRtl ? -h + (a - o.size) : h),
                  (o.el.style.transform =
                    "x" === t ? "translate3d(".concat(h, "px, 0, 0)") : "translate3d(0, ".concat(h, "px, 0)"));
              }
            }),
            ...
            (e.prototype.showScrollbar = function (e) {
              void 0 === e && (e = "y"),
                this.axis[e].isOverflowing &&
                  ...
                  (Uo(this.axis[e].scrollbar.el, this.classNames.visible), (this.axis[e].scrollbar.isVisible = !0));
            }),
            (e.prototype.hideScrollbar = function (e) {
              void 0 === e && (e = "y"),
                this.axis[e].isOverflowing &&
                  this.axis[e].scrollbar.isVisible &&
                  (Ko(this.axis[e].scrollbar.el, this.classNames.visible), (this.axis[e].scrollbar.isVisible = !1));
            }),
            ...
            (e.prototype.onMouseMoveForAxis = function (e) {
              ...
              t.track.el &&
                ...
                this.isWithinBounds(t.track.rect)
                  ...
                  : (Ko(t.track.el, this.classNames.hover), this.options.autoHide && this.hideScrollbar(e)));
            }),
            ...
            (e.prototype.onDragStart = function (e, t) {
              ...
              (this.axis[t].dragOffset =
                r - ((null === (i = o.rect) || void 0 === i ? void 0 : i[this.axis[t].offsetAttr]) || 0)),
                (this.draggedAxis = t),
              ...
              if (this.options.clickOnTrack && a.scrollbar.el && this.contentWrapperEl) {
                ...
                var c =
                    null !==
                      ...
                      : 0,
                  d = parseInt(
                    null !== (o = null === (n = this.elStyles) || void 0 === n ? void 0 : n[this.axis[t].sizeAttr]) &&
                      void 0 !== o
                      ? o
                      : "0px",
                    10
                  ...
                  f = function () {
                    r.contentWrapperEl &&
                      (-1 === u
                        ? h > p &&
                          ((h -= 40), (r.contentWrapperEl[r.axis[t].scrollOffsetAttr] = h), l.requestAnimationFrame(f))
                        : h < p &&
                          ((h += 40),
          ...
          document.querySelectorAll('[data-toggle="click-ripple"]:not(.js-click-ripple-enabled)').forEach((e) => {
            e.classList.add("js-click-ripple-enabled"),
              ...
              e.addEventListener("click", (t) => {
                ...
                (r = e.querySelector("." + o)),
                  ("0px" !== getComputedStyle(r).height && "0px" !== getComputedStyle(r).width) ||
                  ...
                  (s =
                    ...
                    parseFloat(getComputedStyle(r).width.replace("px", "")) / 2),
                  (n =
                    t.pageY -
                    (e.getBoundingClientRect().top + window.scrollY) -
                    parseFloat(getComputedStyle(r).height.replace("px", "")) / 2),
                  (r.style.top = n + "px"),
                  (r.style.left = s + "px"),
                ...
                t.addEventListener("click", (i) => {
                  ...
                  t.checked
                    ? e.querySelectorAll("tbody input[type=checkbox]:checked").length ===
                        e.querySelectorAll("tbody input[type=checkbox]").length && (s.checked = !0)
                    : (s.checked = !1),
        ...
        static jqSparkline() {
          ...
          jQuery(".js-sparkline:not(.js-sparkline-enabled)").each((t, i) => {
            ...
            r[n]
              ? (r[n](),
                "line" === n &&
                  ((s.data("chart-range-min") >= 0 || s.data("chart-range-min")) &&
                    (o.chartRangeMin = s.data("chart-range-min")),
                  (s.data("chart-range-max") >= 0 || s.data("chart-range-max")) &&
          ...
          (t._lSidebar || t._lSideOverlay) &&
            ("init" === e
              ...
              : (e = "custom-scroll") &&
                ...
                (t._lSidebar && !t._lSidebarScroll && (t._lSidebarScroll = new sr(t._lSidebarScrollCon)),
              ...
              init: () => {
                document
                  ...
                  .forEach((e) => {
                    e.innerHTML =
                      '<i class="si ' +
                      (e.closest(".block").classList.contains("block-mode-fullscreen") ? r : o) +
                      '"></i>';
                  }),
                  document
